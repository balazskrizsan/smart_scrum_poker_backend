...
import com.kbalazsworks.smartscrumpokerbackend.socket_api.interceptors.SocketChannelInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer
{
    ...
    @Bean
    public SocketChannelInterceptor rmeSessionChannelInterceptor()
    {
        return new SocketChannelInterceptor(insecureUserSessionsService, localDateTimeFactory);
    }
}
