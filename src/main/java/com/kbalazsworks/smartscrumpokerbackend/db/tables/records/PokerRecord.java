...
public class PokerRecord extends UpdatableRecordImpl<PokerRecord> implements Record5<Long, UUID, String, LocalDateTime, String> {

    private static final long serialVersionUID = 1673673151;
    ...
    @Override
    public PokerRecord value5(String value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public PokerRecord values(Long value1, UUID value2, String value3, LocalDateTime value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PokerRecord(Long id, UUID idSecure, String name, LocalDateTime createdAt, String createdBy) {
        super(Poker.POKER);
